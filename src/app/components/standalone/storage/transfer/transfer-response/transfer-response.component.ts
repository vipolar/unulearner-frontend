...
@Component({
	selector: 'storage-transfer-response',
	templateUrl: './transfer-response.component.html',
	styleUrls: ['./transfer-response.component.scss'],
	imports: [
		CommonModule,
		MatDialogModule,
		MatButtonModule,
...
export class TransferResponseComponent implements OnInit {
	...
	constructor(
		...
		public dialogRef: MatDialogRef<TransferResponseComponent>
	) { }
